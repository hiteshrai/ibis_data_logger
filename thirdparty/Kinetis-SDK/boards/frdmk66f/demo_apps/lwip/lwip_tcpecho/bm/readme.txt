...
Note, The RMII mode is used as the default setting to initialize the ENET interface between MAC and the external PHY. If you want,
if can be changed to MII mode as well. Ensure the MII Mode setting in the MAC is synchronized to the setting
